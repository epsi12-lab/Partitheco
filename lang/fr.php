...
return [
  ...
  'sections' => [
    ...
    'weather'    => 'Météo à Strasbourg',
  ],

  'pages' => [
    'home_title'         => 'Nos dernières publications',
    'about_title'        => 'À propos de nous',
    'publications_title' => 'Toutes les publications',
    'create_title'       => 'Publier un nouveau projet',
    'admin_title'        => 'Tableau de bord administrateur',
    'contact_title'      => 'Nous contacter',
  ],

  'buttons' => [
    'load_more'       => 'Voir plus de publications',
    'submit'          => 'Envoyer',
    'subscribe'       => 'S’abonner',
    'publish'         => 'Publier',
    ...
    'delete'          => 'Supprimer',
    'edit'            => 'Modifier',
    'manage_songs'    => 'Gérer les chants',
    'new_publication' => 'Publier une nouvelle partition',
  ...
  'form' => [
    ...
    'event_date'        => 'Date',
    'paroisse'          => 'Paroisse / Chorale',
    'playlist_name'     => 'Nom de la célébration (ex: Messe du 15 Août)',
    'role_choral'       => 'Rôle (ex: Chef de chœur, Soprano...)',
  ],

  'confirm' => [
    'delete_playlist' => 'Supprimer cette liste ?',
  ...
  'contact' => [
    ...
    'error_email'         => 'L’adresse e-mail est requise.',
  ...
  'admin' => [
    ...
    'no_playlists' => 'Aucune liste de chants créée.',
    'no_publications' => 'Vous n\'avez encore publié aucune partition.',
  ],
  ...
  'errors' => [
    'missing_id' => 'ID de projet manquant.',
